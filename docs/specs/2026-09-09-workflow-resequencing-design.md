...
- The settings allow-list gains the exact git and gh commands the mechanical steps run, so they do not prompt in an unattended run; destructive forms stay unlisted.
